...
<div class="wrapper">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        ...
        <div class="input-group-append">
          <button class="btn btn-navbar" type="submit" style="color: rgb(32, 32, 32)">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('admin.dashboard', auth()->user()) }}" class="brand-link">
      <img src="{{ asset('images/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">BNTC Library</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{ route('admin.dashboard', auth()->user()) }}" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.all_books', auth()->user()) }}" class="nav-link">
