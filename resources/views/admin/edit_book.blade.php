        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12 col-sm-6">
                ...
                <input type="text" name="title" value="{{ $book->title }}" class="form-control mb-3 @error('title') is-invalid
            ...
            <div class="col-12 col-sm-6">
                ...
                <input type="text" name="author" value="{{ $book->author }}" class="form-control mb-3 @error('author') is-invalid
            ...
            <div class="col-md-8">
              ...
              <img src="{{ asset('storage/images/'.$book->image_path) }}" alt="image_preview" style="width: 50px; display:inline">
              </div>
            ...
            <div class="col-12">
                ...
                <textarea name="description" class="form-control" id="description" cols="30" rows="4">{{ $book->description }}</textarea>
                </div>
